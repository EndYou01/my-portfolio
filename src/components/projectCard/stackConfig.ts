...
const ENTRIES: StackEntry[] = [
  ...
  { label: 'Motion', bg: 'rgba(255,255,255,0.06)', color: '#e5e5e5', Icon: SiFramer },
  ...
  { label: 'TanStack Query', bg: 'rgba(255,65,84,0.12)', color: '#ff6b7d', Icon: SiReactquery },
  { label: 'TanStack Router', bg: 'rgba(255,65,84,0.12)', color: '#ff6b7d', Icon: SiReactquery },
  { label: 'Prisma', bg: 'rgba(255,255,255,0.06)', color: '#e5e5e5', Icon: SiPrisma },
  { label: 'Redis', bg: 'rgba(220,56,45,0.14)', color: '#ff6a5e', Icon: SiRedis },
  { label: 'Cloudflare', bg: 'rgba(243,128,32,0.14)', color: '#f8a24f', Icon: SiCloudflare },
  { label: 'wagmi', bg: 'rgba(122,99,255,0.14)', color: '#9d8aff' },
  { label: 'viem', bg: 'rgba(122,99,255,0.14)', color: '#9d8aff' },
  { label: 'Ably', bg: 'rgba(255,87,34,0.12)', color: '#ff8a5f' },
